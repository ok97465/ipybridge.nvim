...
function M.apply_defaults()
	...
	pcall(vim.keymap.set, "n", "<leader>id", my.goto_debug_location, { silent = true, desc = "IPy: Jump to current debug line" })
	...
	pcall(api.nvim_create_user_command, "IpybridgeDebugHere", function()
		require("ipybridge").goto_debug_location()
	end, {})
	pcall(api.nvim_create_user_command, "IpybridgeRestart", function()
		require("ipybridge").restart()
	end, {})
...
function M.apply_buffer(bufnr)
	...
	set("n", "<leader>ir", my.restart, "IPy: Restart kernel")
